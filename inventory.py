...
# FIXED: Imported Item instead of Items to match items.py
...
class ItemStorage:
    ...
    def get_by_index(self, index: int) -> Optional[Item]:
        """
...
class ItemSorter:
    ...
    @staticmethod
    def sort_by_name(items: List[Item], reverse: bool = False) -> List[Item]:
        """
    ...
    @staticmethod
    def sort_by_value(items: List[Item], reverse: bool = True) -> List[Item]:
        """
        Sort items by value
    ...
    @staticmethod
    def sort_by_type(items: List[Item]) -> List[Item]:
        """
...
class ItemUser:
    ...
    @staticmethod
    def use_item(item: Item, entity) -> bool:
        """
        ...
        """
        try:
            if hasattr(item, 'use'): # Fixed method name to match items.py
                item.use(entity)
                return True
            return False
...
class InventoryDisplay:
    ...
    @staticmethod
    def display_items(items: List[Item]) -> None:
        """
